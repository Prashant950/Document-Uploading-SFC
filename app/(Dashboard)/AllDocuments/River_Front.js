...
const River_Front = () => {
  ...
  const [docKey, setDocKey] = useState("River_Front"); // default document type
  ...
  const { data: documentCategoriesData, refetch } =
    useGetDocumentWithCategoriesQuery({ docKey: "River_Front" });
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("docKey", docKey || "River_Front");
